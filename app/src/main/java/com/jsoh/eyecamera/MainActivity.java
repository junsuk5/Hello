...
import com.jsoh.eyecamera.ui.camera.CameraSourcePreview;
...
public final class MainActivity extends AppCompatActivity {
    ...
    private void requestCameraPermission() {
        ...
        Snackbar.make(mGraphicOverlay, "카메라 권한",
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        builder.setTitle("Face Tracker sample")
                .setMessage("카메라 권한이 없음")
                .setPositiveButton("닫기", listener)
                .show();
    }
    ...
    private class GraphicFaceTracker extends Tracker<Face> {
        ...
        private EyeGraphic mFaceGraphic;

        GraphicFaceTracker(GraphicOverlay overlay) {
            mOverlay = overlay;
            mFaceGraphic = new EyeGraphic(overlay);
        }
        ...
        public void onNewItem(int faceId, Face item) {
            ...
            // 인사말
            mSoundPool.play(mSoundHello, 1f, 1f, 1, 0, 1);
        }
